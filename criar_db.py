...
def insert_dados():
    ...
    perguntas = [
        (1,'Quanto trabalhar na ambev é motivo de orgulho para mim ?',1),
        (2,'Quanto eu me identifico com os 10 princípios da ambev ?',1),
        (3,'Tendo a ficar na ambev por pelo menos mais 12 meses ?',1),
        (4,'Quanto meu trabalho impacta positivamente na minha vida pessoal ?',1),
        (5,'Quão claro é o meu gestor nas atividades que delega ?',2),
        (6,'Quanto a comunicação entre você e seu gestor direto é transparente ?',2),
        (7,'Quanto minhas entregas são reconhecidas ?',2),
        (8,'Quanto eu sinto que a minha opinião é levada em consideração para a solução de problemas ?',2),
        (9,'Quanto meu superior oferece suporte para a realização do meu trabalho ?',2),
        ...
        (12,'Quanto eu me sinto capacitado para realizar meus papéis e responsabildiades ?',3),
        (13,'Nos últimos 3 meses em algum momento eu senti que não tinha tempo suficiente para realizar minhas funções ?',3),
